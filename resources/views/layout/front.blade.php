        ...
        <div class="row mega-menu-relative"> 
          ...
          <div class="col-md-9 col-sm-12 hidden-xs">
            <nav class="main-menu-area">
              ...
              <li><a href="/storelist.php">Stores List</a></li>
              
              @if(Auth::check())
                <li> <a href="/store/profile.php?view=dashboard">Profile</a></li>
                ...
                <li><a href="/store/sales/managesales.php?view=list">My Sales</a>
                    <ul class="main-dropdown-menu">
                        <li><a href="../../store/sales/managesales.php?view=create">Create Sale</a></li>
                    </ul>
                </li>
                <li> <a >Settings</a></li>
